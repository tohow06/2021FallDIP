...
public:
    ...
    void setupUi(QMainWindow *diphw)
    {
        ...
        sizePolicy1.setHeightForWidth(inverseButton->sizePolicy().hasHeightForWidth());
        inverseButton->setSizePolicy(sizePolicy1);

        verticalLayout_3->addWidget(inverseButton);
